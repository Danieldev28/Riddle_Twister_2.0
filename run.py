...
# -------app route to the index login page/flash message on input send------>
...
# ----retrives a riddle from my database--->
...
# -------api which checks users input against correct answer---->
...
#----api which retrives that username and score from the user and stores it to be displayed in leaderboard--->
...
# this section is left in my code for added functionality---->

# ---------these are the hints for the game----->
